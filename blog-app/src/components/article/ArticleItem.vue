<template>
  <el-card class="me-area" :body-style="{ padding: '16px' }">
    ...
    <div class="me-article-footer">
        ...
        <i class="el-icon-location-outline" @click="guanzhu(author.id)" >关注他/她</i>
	    </span>
...
<script>
    ...
    import {setGuanzhu} from '@/api/article'
    export default {
        name: 'ArticleItem',
        props: {
            id: Number,
        ...
        methods: {
            ...
            guanzhu: function (userid) {
                ...
                console.error("23232:"+userid)

                setGuanzhu(userid).then(data => {

                    this.$message({type: 'success', message: '关注成功!', showClose: true})

                }).catch(error => {
                    if (error !== 'error') {
                        this.$message({type: 'error', message: '关注失败!', showClose: true})
                    }
                }).finally(() => {
