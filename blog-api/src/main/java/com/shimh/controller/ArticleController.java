...
public class ArticleController {
    ...
    @FastJsonView(
            ...
            include = {@FastJsonFilter(clazz = User.class, props = {"nickname","id"})})
    ...
    @GetMapping("/guanzhu/{userId}")
    @LogAnnotation(module = "关注", operation = "关注好友")
    public Result guanzhu(@PathVariable Integer userId) {

        articleService.guanzhu(userId);
    ...
    @GetMapping("/myquanquan")
    @LogAnnotation(module = "好友", operation = "我的好友")
    public Result myquanquan() {
        return Result.success(articleService.myquanquan());
    }
    ...
    @GetMapping("/quxiaoguanzhu/{id}")
    @LogAnnotation(module = "圈圈", operation = "取消关注")
    public Result quxiaoguanzhu(@PathVariable("id") Integer id) {
        Result r = new Result();
        ...
        articleService.deleteGuanzhuById(id);

        r.setResultCode(ResultCode.SUCCESS);
        return r;
    }

    @GetMapping("/listArchives/{id}")
    @LogAnnotation(module = "文章", operation = "根据用户id获取文章")
    public Result listArchives(@PathVariable("id") Integer id) {
        return Result.success(articleService.listArchives(id));
    }

    @GetMapping("/listArchives")
    @LogAnnotation(module = "文章", operation = "获取文章归档日期")
    public Result listArchives() {
        return Result.success(articleService.listArchives(null));
    }
