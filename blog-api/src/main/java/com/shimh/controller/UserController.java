...
public class UserController {
    ...
    @FastJsonView(
            include = {@FastJsonFilter(clazz = User.class, props = {"id", "account", "nickname", "avatar", "email", "createDate", "mobilePhoneNumber"})})
    ...
    @GetMapping("/integral")
    @LogAnnotation(module = "用户", operation = "积分排行榜")
    public Result integral() {
        List<User> users = userService.getAllByOrderByIntegralDesc();
        return Result.success(users);
    }
