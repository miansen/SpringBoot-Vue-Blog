...
//        return query.list();
    ...
    public List<ArticleVo> listArchives(Integer id) {
       if(id==null){
           ...
           String sql = "select year(create_date) as year,month(create_date) as month,count(*) as count from me_article where author_id="+id+" group by year(create_date),month(create_date)";
